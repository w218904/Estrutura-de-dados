...
int Remover_metade_LED(Tno_ld **p_inicio) {
    ...
    // Se o tamanho da lista for 1, não há nada para remover
    if (tam == 1) {
        free(percorre);
        *p_inicio = NULL;
        return 0;
    ...
    // Se não há nada para remover (lista com menos de 2 elementos)
    ...
    // Atualizar o início da lista se necessário
